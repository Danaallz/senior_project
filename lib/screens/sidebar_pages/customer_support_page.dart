  ...
  Future<void> _submitTicket() async {
    ...
    try {
      await supabaseService.createSupportTicket(
        ...
        subject: cleanInput(_subjectController.text),
        message: cleanInput(_messageController.text),
      );
      ...
      ScaffoldMessenger.of(context).showSnackBar(
        const SnackBar(
          content: Text("Unable to submit ticket. Please try again."),
      ...
      children: [
        ...
        TextFormField(
          ...
          validator: (v) {
            ...
            if (label == "Message" && v.trim().length < 10) {
  ...
  Widget _contactOption({
    ...
    return Expanded(
      child: Container(
        ...
        child: Column(
          children: [
            Icon(icon, color: const Color(0xFF0D1A3A), size: 28),
